...
/*
 * AES vectors from NIST SP 800-38A, appendix F. The keys, the plaintext and
 * the IVs below are shared by the ECB, CBC and CTR tests that follow; each
 * mode adds its own ciphertext. Together they cover all three key lengths,
 * which an accelerated AES handles with different round counts, over four
 * blocks, which is enough to exercise a multi-block loop rather than a
 * single block at a time.
 *
 * The existing AES cipher cases in ciph_cases[] are all 128-bit, so the 192-
 * and 256-bit key schedules were previously untested.
 */
static const uint8_t ciph_data_aes_nist_key_128[] = {
	0x2b, 0x7e, 0x15, 0x16, 0x28, 0xae, 0xd2, 0xa6,
	0xab, 0xf7, 0x15, 0x88, 0x09, 0xcf, 0x4f, 0x3c,
};

static const uint8_t ciph_data_aes_nist_key_192[] = {
	0x8e, 0x73, 0xb0, 0xf7, 0xda, 0x0e, 0x64, 0x52,
	0xc8, 0x10, 0xf3, 0x2b, 0x80, 0x90, 0x79, 0xe5,
	0x62, 0xf8, 0xea, 0xd2, 0x52, 0x2c, 0x6b, 0x7b,
};

static const uint8_t ciph_data_aes_nist_key_256[] = {
...
static const uint8_t ciph_data_aes_nist_ptx[] = {
...
static const uint8_t ciph_data_aes_nist_ecb_ctx_128[] = {
...
static const uint8_t ciph_data_aes_nist_ecb_ctx_192[] = {
...
static const uint8_t ciph_data_aes_nist_ecb_ctx_256[] = {
...
static const struct xtest_ciph_case ciph_cases_aes_ecb[] = {
	XTEST_CIPH_CASE_NO_IV(TEE_ALG_AES_ECB_NOPAD, TEE_TYPE_AES,
			      ciph_data_aes_nist_key_128, 16,
			      ciph_data_aes_nist_ptx,
			      ciph_data_aes_nist_ecb_ctx_128),
	XTEST_CIPH_CASE_NO_IV(TEE_ALG_AES_ECB_NOPAD, TEE_TYPE_AES,
			      ciph_data_aes_nist_key_128, 11,
			      ciph_data_aes_nist_ptx,
			      ciph_data_aes_nist_ecb_ctx_128),
	XTEST_CIPH_CASE_NO_IV(TEE_ALG_AES_ECB_NOPAD, TEE_TYPE_AES,
			      ciph_data_aes_nist_key_192, 16,
			      ciph_data_aes_nist_ptx,
			      ciph_data_aes_nist_ecb_ctx_192),
	XTEST_CIPH_CASE_NO_IV(TEE_ALG_AES_ECB_NOPAD, TEE_TYPE_AES,
			      ciph_data_aes_nist_key_192, 11,
			      ciph_data_aes_nist_ptx,
			      ciph_data_aes_nist_ecb_ctx_192),
	XTEST_CIPH_CASE_NO_IV(TEE_ALG_AES_ECB_NOPAD, TEE_TYPE_AES,
			      ciph_data_aes_nist_key_256, 16,
			      ciph_data_aes_nist_ptx,
			      ciph_data_aes_nist_ecb_ctx_256),
	XTEST_CIPH_CASE_NO_IV(TEE_ALG_AES_ECB_NOPAD, TEE_TYPE_AES,
			      ciph_data_aes_nist_key_256, 11,
			      ciph_data_aes_nist_ptx,
			      ciph_data_aes_nist_ecb_ctx_256),
};
...
{
	xtest_cipher_cases(c, ciph_cases_aes_ecb,
			   ARRAY_SIZE(ciph_cases_aes_ecb));
}
ADBG_CASE_DEFINE(regression, 4020, xtest_tee_test_4020,
		"Test AES-ECB against the NIST SP 800-38A vectors");

/* IV shared by F.2.1, F.2.3 and F.2.5 */
static const uint8_t ciph_data_aes_nist_cbc_iv[] = {
	0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07,
	0x08, 0x09, 0x0a, 0x0b, 0x0c, 0x0d, 0x0e, 0x0f,
};

/* F.2.1 CBC-AES128.Encrypt */
static const uint8_t ciph_data_aes_nist_cbc_ctx_128[] = {
...
static const uint8_t ciph_data_aes_nist_cbc_ctx_192[] = {
...
static const uint8_t ciph_data_aes_nist_cbc_ctx_256[] = {
...
static const struct xtest_ciph_case ciph_cases_aes_cbc[] = {
	XTEST_CIPH_CASE(TEE_ALG_AES_CBC_NOPAD, TEE_TYPE_AES,
			ciph_data_aes_nist_key_128,
			ciph_data_aes_nist_cbc_iv, 16,
			ciph_data_aes_nist_ptx,
			ciph_data_aes_nist_cbc_ctx_128),
	XTEST_CIPH_CASE(TEE_ALG_AES_CBC_NOPAD, TEE_TYPE_AES,
			ciph_data_aes_nist_key_128,
			ciph_data_aes_nist_cbc_iv, 11,
			ciph_data_aes_nist_ptx,
			ciph_data_aes_nist_cbc_ctx_128),
	XTEST_CIPH_CASE(TEE_ALG_AES_CBC_NOPAD, TEE_TYPE_AES,
			ciph_data_aes_nist_key_192,
			ciph_data_aes_nist_cbc_iv, 16,
			ciph_data_aes_nist_ptx,
			ciph_data_aes_nist_cbc_ctx_192),
	XTEST_CIPH_CASE(TEE_ALG_AES_CBC_NOPAD, TEE_TYPE_AES,
			ciph_data_aes_nist_key_192,
			ciph_data_aes_nist_cbc_iv, 11,
			ciph_data_aes_nist_ptx,
			ciph_data_aes_nist_cbc_ctx_192),
	XTEST_CIPH_CASE(TEE_ALG_AES_CBC_NOPAD, TEE_TYPE_AES,
			ciph_data_aes_nist_key_256,
			ciph_data_aes_nist_cbc_iv, 16,
			ciph_data_aes_nist_ptx,
			ciph_data_aes_nist_cbc_ctx_256),
	XTEST_CIPH_CASE(TEE_ALG_AES_CBC_NOPAD, TEE_TYPE_AES,
			ciph_data_aes_nist_key_256,
			ciph_data_aes_nist_cbc_iv, 11,
			ciph_data_aes_nist_ptx,
...
{
	xtest_cipher_cases(c, ciph_cases_aes_cbc,
			   ARRAY_SIZE(ciph_cases_aes_cbc));
}
ADBG_CASE_DEFINE(regression, 4021, xtest_tee_test_4021,
		"Test AES-CBC against the NIST SP 800-38A vectors");

/* Initial counter block shared by F.5.1, F.5.3 and F.5.5 */
static const uint8_t ciph_data_aes_nist_ctr_iv[] = {
	0xf0, 0xf1, 0xf2, 0xf3, 0xf4, 0xf5, 0xf6, 0xf7,
	0xf8, 0xf9, 0xfa, 0xfb, 0xfc, 0xfd, 0xfe, 0xff,
};

/* F.5.1 CTR-AES128.Encrypt */
static const uint8_t ciph_data_aes_nist_ctr_ctx_128[] = {
...
static const uint8_t ciph_data_aes_nist_ctr_ctx_192[] = {
...
static const uint8_t ciph_data_aes_nist_ctr_ctx_256[] = {
...
/*
 * CTR is a stream cipher, so unlike ECB and CBC it accepts a length that is
 * not a whole number of blocks. This is the SP 800-38A CTR-AES256 case cut
 * short mid-block, so that the last block is a partial one.
 */
static const uint8_t ciph_data_aes_nist_ctr_ptx_partial[] = {
	0x6b, 0xc1, 0xbe, 0xe2, 0x2e, 0x40, 0x9f, 0x96,
	0xe9, 0x3d, 0x7e, 0x11, 0x73, 0x93, 0x17, 0x2a,
	0xae, 0x2d, 0x8a, 0x57, 0x1e, 0x03, 0xac, 0x9c,
	0x9e, 0xb7, 0x6f, 0xac, 0x45, 0xaf, 0x8e, 0x51,
...
static const uint8_t ciph_data_aes_nist_ctr_ctx_partial_256[] = {
	0x60, 0x1e, 0xc3, 0x13, 0x77, 0x57, 0x89, 0xa5,
	0xb7, 0xa7, 0xf5, 0x04, 0xbb, 0xf3, 0xd2, 0x28,
	0xf4, 0x43, 0xe3, 0xca, 0x4d, 0x62, 0xb5, 0x9a,
	0xca, 0x84, 0xe9, 0x90, 0xca, 0xca, 0xf5, 0xc5,
	...
	0xe8, 0x70, 0x17, 0xba, 0x2d, 0x84, 0x98, 0x8d,
	0xdf, 0xc9, 0xc5, 0x8d, 0xb6, 0x7a, 0xad, 0xa6,
	0x13, 0xc2, 0xdd, 0x08, 0x45,
};

/*
 * The counter is a 128-bit big-endian value, but an accelerator that counts
 * several blocks ahead in vector registers will naturally do the arithmetic
 * on the low 32 bits alone, because that is what fits one element of a
 * counter block. Carry out of those low 32 bits is then a separate path, and
 * nothing above reaches it: every SP 800-38A CTR vector leaves the counter
 * inside its low byte.
 *
 * These two cross that boundary. The first starts at all-ones, so the whole
 * block wraps to zero after one block; the second starts with the low 32
 * bits all-ones and a non-trivial value above them, so the carry has to land
 * in the upper 96 bits rather than be dropped. Both were generated with a
 * reference AES.
 */
static const uint8_t ciph_data_aes_nist_ctr_wrap_iv[] = {
	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
};

static const uint8_t ciph_data_aes_nist_ctr_wrap_ctx_128[] = {
	...
	0x67, 0xda, 0x61, 0x06, 0x97, 0xed, 0x5a, 0xae,
	0x4b, 0x0f, 0xa7, 0xa0, 0xdd, 0x78, 0x3d, 0x29,
	0x61, 0xa0, 0x0a, 0xb6, 0x97, 0x36, 0x79, 0x15,
	0xd2, 0x3c, 0x75, 0x4b, 0xd9, 0x9e, 0x28, 0x99,
};

static const uint8_t ciph_data_aes_nist_ctr_carry_iv[] = {
	0x00, 0x11, 0x22, 0x33, 0x44, 0x55, 0x66, 0x77,
	0x88, 0x99, 0xaa, 0xbb, 0xff, 0xff, 0xff, 0xff,
};

static const uint8_t ciph_data_aes_nist_ctr_carry_ctx_256[] = {
	0xab, 0xa9, 0xab, 0xf0, 0x0e, 0x46, 0x20, 0xa1,
	0xfd, 0x5e, 0x46, 0x23, 0xdc, 0x94, 0x36, 0xbc,
	0x78, 0x85, 0x87, 0xf7, 0xa7, 0x9a, 0xe2, 0xf2,
	0x2e, 0xf4, 0x92, 0x49, 0x2e, 0xf3, 0x40, 0x27,
	0x54, 0x56, 0xab, 0xcc, 0xc3, 0x53, 0x45, 0x95,
	0x9b, 0x6d, 0x68, 0x5e, 0x7b, 0x1f, 0xaa, 0x9e,
	0x08, 0xcc, 0x0a, 0x9b, 0xf0, 0x72, 0xda, 0x35,
	0xef, 0x8c, 0xfb, 0x51, 0x70, 0x98, 0x1b, 0x3e,
};

static const struct xtest_ciph_case ciph_cases_aes_ctr[] = {
	XTEST_CIPH_CASE(TEE_ALG_AES_CTR, TEE_TYPE_AES,
			ciph_data_aes_nist_key_128,
			ciph_data_aes_nist_ctr_iv, 16,
			ciph_data_aes_nist_ptx,
			ciph_data_aes_nist_ctr_ctx_128),
	XTEST_CIPH_CASE(TEE_ALG_AES_CTR, TEE_TYPE_AES,
			ciph_data_aes_nist_key_128,
			ciph_data_aes_nist_ctr_iv, 11,
			ciph_data_aes_nist_ptx,
			ciph_data_aes_nist_ctr_ctx_128),
	XTEST_CIPH_CASE(TEE_ALG_AES_CTR, TEE_TYPE_AES,
			ciph_data_aes_nist_key_192,
			ciph_data_aes_nist_ctr_iv, 16,
			ciph_data_aes_nist_ptx,
			ciph_data_aes_nist_ctr_ctx_192),
	XTEST_CIPH_CASE(TEE_ALG_AES_CTR, TEE_TYPE_AES,
			ciph_data_aes_nist_key_192,
			ciph_data_aes_nist_ctr_iv, 11,
			ciph_data_aes_nist_ptx,
	...
	XTEST_CIPH_CASE(TEE_ALG_AES_CTR, TEE_TYPE_AES,
			...
			ciph_data_aes_nist_ctr_iv, 16,
			ciph_data_aes_nist_ptx,
			ciph_data_aes_nist_ctr_ctx_256),
	XTEST_CIPH_CASE(TEE_ALG_AES_CTR, TEE_TYPE_AES,
			ciph_data_aes_nist_key_256,
			ciph_data_aes_nist_ctr_iv, 11,
			ciph_data_aes_nist_ptx,
	...
	XTEST_CIPH_CASE(TEE_ALG_AES_CTR, TEE_TYPE_AES,
			ciph_data_aes_nist_key_256,
			ciph_data_aes_nist_ctr_iv, 16,
			ciph_data_aes_nist_ctr_ptx_partial,
			ciph_data_aes_nist_ctr_ctx_partial_256),
	XTEST_CIPH_CASE(TEE_ALG_AES_CTR, TEE_TYPE_AES,
			ciph_data_aes_nist_key_256,
			ciph_data_aes_nist_ctr_iv, 13,
			ciph_data_aes_nist_ctr_ptx_partial,
			ciph_data_aes_nist_ctr_ctx_partial_256),

	/* Counter wrap, and carry out of the low 32 bits */
	XTEST_CIPH_CASE(TEE_ALG_AES_CTR, TEE_TYPE_AES,
			ciph_data_aes_nist_key_128,
			ciph_data_aes_nist_ctr_wrap_iv, 16,
			ciph_data_aes_nist_ptx,
			ciph_data_aes_nist_ctr_wrap_ctx_128),
	XTEST_CIPH_CASE(TEE_ALG_AES_CTR, TEE_TYPE_AES,
			ciph_data_aes_nist_key_256,
			ciph_data_aes_nist_ctr_carry_iv, 16,
			ciph_data_aes_nist_ptx,
			ciph_data_aes_nist_ctr_carry_ctx_256),
};

static void xtest_tee_test_4022(ADBG_Case_t *c)
{
	xtest_cipher_cases(c, ciph_cases_aes_ctr,
			   ARRAY_SIZE(ciph_cases_aes_ctr));
}
ADBG_CASE_DEFINE(regression, 4022, xtest_tee_test_4022,
		"Test AES-CTR against the NIST SP 800-38A vectors");
